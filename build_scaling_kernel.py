#!/usr/bin/env python3
"""Build PSN-1 scaling law Kaggle kernel."""
...
src_files["exp/psn1_scaling_law.py"] = open(EXP / "psn1_scaling_law.py", encoding="utf-8").read()
...
SCRIPT = r'''"""PSN-1 Scaling Law kernel -- built by build_scaling_kernel.py"""
...
cmd = [sys.executable, str(SRCDIR / "exp/psn1_scaling_law.py")] + ARGS
print("run", " ".join(cmd), flush=True)
os.execve(cmd[0], cmd, env)
'''

OUT = WORK / "kernel" / "psn1_scaling_law"
OUT.mkdir(parents=True, exist_ok=True)
(OUT / "psn1_scaling_law.py").write_text(SCRIPT, encoding="utf-8")

meta = {
    "id": "sehajrsingh/psn1-scaling-law",
    "title": "PSN-1 Scaling Law (1K-157K params x 9 domains)",
    "code_file": "psn1_scaling_law.py",
    "language": "python",
    "kernel_type": "script",
    "is_private": True,
    "enable_gpu": True,
